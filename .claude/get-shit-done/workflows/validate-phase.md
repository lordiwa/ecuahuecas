...
```
Task(
  prompt="Read C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/templates/VALIDATION.md`
