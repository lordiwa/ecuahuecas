...
@C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/references/revision-loop.md
@C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/references/gate-prompts.md
...
**If found:**
1. Read template: `C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/references/tdd.md to all eligible tasks:
...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  node "C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/bin/gsd-tools.cjs" gap-analysis --phase-dir "${PHASE_DIR}"
fi
```
