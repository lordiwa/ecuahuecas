...
```bash
INIT=$(node "C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/RafaelMatovelle/Documents/EcuaHuecas/.claude/get-shit-done/templates/spec.md.
