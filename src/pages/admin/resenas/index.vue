...
// Admin access is enforced by the /admin route guard (Firestore allowlist via
// checkAdmin). A non-admin never reaches this page, so there is no in-page
// activation/request UI anymore (TASK-025 removed the TASK-024 gating card).
